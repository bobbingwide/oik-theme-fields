...
== Changelog == 
= 0.0.2 = 
* Added: Add logic to set the featured image to the screenshot.png or .jpg file found locally, from wordpress.org or GitHub [github bobbingwide oik-theme-fields issue 4]
